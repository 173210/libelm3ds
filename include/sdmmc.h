...
#define REG_SDRESP1				0x10
#define REG_SDRESP2				0x14
#define REG_SDRESP3				0x18

#define REG_SDSTATUS			0x1c

#define REG_SDIRMASK			0x20
...
//---------------------------------------------------------------------------------
static inline void sdmmc_mask32(uint16_t reg, const uint32_t clear, const uint32_t set) {
//---------------------------------------------------------------------------------
